...
export const COURTS = [
  ...
  { name: 'National Consumer Disputes Redressal Commission, New Delhi', highlighted: false },
  ...
  { name: 'Real Estate Regulatory Authority & Appellate Tribunal, Dehradun', highlighted: false },
  { name: 'District & State Consumer Disputes Redressal Forums', highlighted: false },
]
...
export const TEAM_FOUNDER = {
  ...
  expertise: ['Civil Litigation', 'Criminal Matters', 'High Courts', 'Supreme Court', 'SC Law Clerk'],
}

export const TEAM_MEMBERS = [
  { role: 'Senior Associate', name: 'Narendra Singh', specialty: 'Trial including Original Civil Suits' },
  { role: 'Associate', name: 'Prasanna Karnatak', specialty: 'Appellate Jurisdiction' },
  { role: 'Associate', name: 'Divyansh Rohilla', specialty: 'Original Civil Suits & Other Forums' },
  { role: 'Associate', name: 'Siddharth Gupta', specialty: 'Trial including Legal Research' },
  { role: 'Associate', name: 'Ms. Namrata', specialty: 'Legal Compliances' },
  { role: 'Clerk', name: 'Karan Kumar', specialty: 'High Court Work at Nainital' },
  { role: 'Clerk', name: 'Vijay Singh', specialty: 'District Courts & Forums at Dehradun' },
]
