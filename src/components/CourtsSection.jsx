        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <Reveal>
            ...
            <h2 className="font-display text-5xl lg:text-6xl font-light dark:text-stone-100 text-stone-900 leading-tight">
              Courts &<br />
              <span className="italic" style={{ color: 'var(--gold)' }}>Tribunals</span>
            </h2>
            <p className="mt-6 dark:text-stone-400 text-stone-600 font-light leading-relaxed">
              From the Supreme Court of India to specialized tribunals, our experienced team practices across the full
              spectrum of India's judicial hierarchy.
            </p>
            <div className="mt-10">
              ...
              <address className="not-italic dark:text-stone-300 text-stone-700 font-light leading-loose">
                Opposite SDM Court,<br />District Court Compound,<br />Dehradun, Uttarakhand
              </address>
            </div>
          </Reveal>
              ...
              {COURTS.map((court) => (
                <div
                  ...
                  className={[
                    ...
                    court.highlighted ? 'border-gold-400' : 'border-transparent hover:border-gold-400',
                  ].join(' ')}
                >
                  {court.highlighted
                  ...
                  <span className={`font-light text-sm ${court.highlighted ? 'dark:text-stone-300 text-stone-700' : 'dark:text-stone-400 text-stone-600'}`}>
                    {court.name}
                  </span>
                </div>
              ))}
