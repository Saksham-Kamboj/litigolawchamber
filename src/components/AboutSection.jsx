          ...
          <div>
            ...
            <Reveal delay={100}>
              <h2 className="font-display text-5xl lg:text-6xl font-light dark:text-stone-100 text-stone-900 mb-8 leading-tight">
                Young Lawyers.<br />
                <span className="italic" style={{ color: 'var(--gold)' }}>Formidable Team.</span>
              </h2>
            </Reveal>
            ...
            <Reveal delay={200}>
              <div className="space-y-5 dark:text-stone-400 text-stone-600 font-light leading-relaxed">
                <p>
                  Litigo Law Chambers is a dynamic law firm based in Uttarakhand, India, constituted by a group of young
                  and passionate lawyers who epitomize the face of the new generation legal practice.
                </p>
                <p>
                  In a short span, the firm has achieved great heights and handles a niche clientele including various
                  corporate houses, financial institutions, co-operative societies and firms across India.
                </p>
                <p>
                  With associates in all major cities of India, the firm believes that having superior infrastructure is
                  quintessential in providing the highest quality service to its clients.
                </p>
              </div>
            </Reveal>
