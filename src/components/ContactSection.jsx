  ...
  return (
    <div className="flex gap-5 items-start group">
      <div className="w-10 h-10 border border-stone-700 group-hover:border-gold-400 flex items-center justify-center shrink-0 transition-colors">
        <span className="text-stone-400 group-hover:text-gold-400 transition-colors">{icon}</span>
      </div>
      <div>
...
export default function ContactSection() {
  ...
  return (
    <section
      ...
      style={{ background: 'linear-gradient(135deg, #0a0d12 0%, #111419 100%)' }}
    >
      {/* Gold mesh bg */}
      <div
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <Reveal>
            ...
            <h2 className="font-display text-5xl lg:text-6xl font-light text-stone-100 leading-tight mb-6">
              Let's Discuss<br />
              <span className="italic" style={{ color: 'var(--gold)' }}>Your Case</span>
            </h2>
            <p className="text-stone-400 font-light leading-relaxed mb-12">
              Reach out to Litigo Law Chambers for expert legal guidance. Our team is ready to provide dedicated support
            ...
            <div className="space-y-8">
              <ContactItem icon={<LocationIcon />} label="Chamber">
                <address className="not-italic text-stone-300 font-light text-sm leading-relaxed">
                  Opposite SDM Court, District Court Compound,<br />Dehradun, Uttarakhand
                </address>
              </ContactItem>

              <ContactItem icon={<BuildingIcon />} label="Office">
                <address className="not-italic text-stone-300 font-light text-sm leading-relaxed">
                  11-DS, 2nd Floor, PLS Plaza,<br />58 Gandhi Road, Dehradun, Uttarakhand
                </address>
              </ContactItem>

              <ContactItem icon={<EmailIcon />} label="Email">
                <a href="mailto:naman@lawyer.com" className="text-stone-300 hover:text-gold-400 font-light text-sm transition-colors block">
                  naman@lawyer.com
                </a>
                <a href="mailto:litigolaw@gmail.com" className="text-stone-300 hover:text-gold-400 font-light text-sm transition-colors block">
                  litigolaw@gmail.com
                </a>
              </ContactItem>

              <ContactItem icon={<PhoneIcon />} label="Phone">
                <a href="tel:+918126630631" className="text-stone-300 hover:text-gold-400 font-light text-sm transition-colors block">
                  +91-8126630631
                </a>
                <a href="tel:+919868650636" className="text-stone-300 hover:text-gold-400 font-light text-sm transition-colors block">
                  +91-9868650636
                </a>
              </ContactItem>
            </div>
