...
export default function TeamSection() {
  return (
    <section
      id="team"
      className="py-24 lg:py-36 dark:bg-slate-950 bg-stone-50 px-4 lg:px-12 relative overflow-hidden"
    >
      {/* Gold mesh bg */}
      <div
          ...
          {TEAM_MEMBERS.map((member, i) => (
            <Reveal key={member.name} delay={i * 60}>
              <div className="team-card dark:bg-stone-900/80 bg-white p-7 h-full">
                ...
                <p className="text-xs dark:text-stone-500 text-stone-500 leading-relaxed">
                  {member.specialty}
                </p>
              </div>
            </Reveal>
